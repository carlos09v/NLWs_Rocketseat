...
export function CreateTripPage() {
    ...
    const [emailsToInvite, setEmailsToInvite] = useState(['Insira seu email (remova esse)'])
    ...
    const addNewEmailToInvite = (e: FormEvent<HTMLFormElement>) => {
        ...
        if (!email) return
        if (emailsToInvite.includes(email)) return // Verifica se o email ja existe na lista
        ...
        e.currentTarget.reset() // Apaga/reseta o input/form
    }
