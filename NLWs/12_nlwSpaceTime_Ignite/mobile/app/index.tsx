...
const discovery = {
    ...
    revocationEndpoint: 'https://github.com/settings/connections/applications/8b4efed6a461d3d7568f',
};
...
export default function App() {
    ...
    const handleGitHubOAuthCode = async (code: string) => {
        ...
        await setItemAsync('token', token) // Salvar no Local do mobile
