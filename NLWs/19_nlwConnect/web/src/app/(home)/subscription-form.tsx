...
export function SubscriptionForm() {
  ...
  // Precisa ser um client component (javascript no navegador) pq captura o envio do usuario
  async function onSubscribe({ name, email }: SubscriptionSchema) {
    const referrer = searchParams.get('referrer')
    
    // Ler a função do arquivo http gerada pelo orval
    // Obs: o endpoint é da Trilha Node e não do Java
