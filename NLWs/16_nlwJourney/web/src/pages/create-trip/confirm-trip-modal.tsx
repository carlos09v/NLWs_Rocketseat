...
export const ConfirmTripModal = ({ closeConfirmTripModal, createTrip, setOwnerEmail, setOwnerName, destination, eventStartAndEndDates }: ConfirmTripModalProps) => {
            ...
            <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-zinc-400">
                        Para concluir a criação da viagem para <span className='font-semibold text-zinc-100'>{destination}</span> nas datas de {eventStartAndEndDates ? (
                            <span className='font-semibold text-zinc-100'>{displayedDate} </span>
                        ): (
                            <span className='font-semibold text-zinc-100'>(sem data) </span>
